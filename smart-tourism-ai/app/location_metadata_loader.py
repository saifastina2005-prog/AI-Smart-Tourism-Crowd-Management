...
CSV_PATH = r"C:\Users\angel\OneDrive\Desktop\crowd_mgmt\smart-tourism-ai\data\pedestrian-counting-system-monthly-counts-per-hour.csv"

DB_CONFIG = {
    "host": "localhost",
    "database": "smart-tourism-ai",
    "user": "postgres",
    "password": "Shaz@1234",   # change this
    "port": "5432"
}
